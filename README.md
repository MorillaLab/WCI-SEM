...
![Figure 1 – Theoretical model with latent and observed variables]([figures/Figure_1.jpg](https://github.com/MorillaLab/multimorbidity-SEM/blob/main/Figure1.png)
